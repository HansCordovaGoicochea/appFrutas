...
public class ScrollingSaludActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_scrolling_salud);
        ...
        String idsalud = intent.getStringExtra("idsalud");
        salud = Salud.findById(Salud.class, Integer.valueOf(idsalud));

//        Toast.makeText(getApplicationContext(), idvehiculo.toString(),Toast.LENGTH_SHORT).show();
        fruta = Fruta.findById(Fruta.class, salud.getIdfruta());
        ...
        descripcion.setText(getParagraphedString(this.salud.getDescripcion()));
