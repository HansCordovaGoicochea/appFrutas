...
public class SaludAdapter extends RecyclerView.Adapter<SaludAdapter.ViewHolder>{
    ...
    public SaludAdapter(Context context, List<Fruta> frutas) {
    ...
    @NonNull
    @Override
    public SaludAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.item_fruta_salud, parent, false);
    ...
    @Override
    public void onBindViewHolder(@NonNull final SaludAdapter.ViewHolder holder, final int position) {
