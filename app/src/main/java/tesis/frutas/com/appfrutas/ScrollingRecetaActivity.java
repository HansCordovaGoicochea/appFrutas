...
public class ScrollingRecetaActivity extends AppCompatActivity {
    ...
    ImageView month;
    TextView ingredientes, procedimiento;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_scrolling_receta);
        ...
        String idreceta = intent.getStringExtra("idreceta");
        receta = Receta.findById(Receta.class, Integer.valueOf(idreceta));

//        Toast.makeText(getApplicationContext(), idvehiculo.toString(),Toast.LENGTH_SHORT).show();
        fruta = Fruta.findById(Fruta.class, receta.getIdfruta());
        ...
        ingredientes = (TextView) findViewById(R.id.elementIngredientes);
        ingredientes.setText(getParagraphedString(this.receta.getIngredientes()));


        procedimiento = (TextView) findViewById(R.id.elementProcedimiento);
        procedimiento.setText(getParagraphedString(this.receta.getProcedimiento()));
